...
function toggle_left(no_animate)
{
    ...
    if(cur_left==1) //Close it
    {
        ...
        //Show Col2
        if(width_col2 <= 460){
        $("#COL2").animate({opacity:'1', padding:'0px 15px 30px 15px'}, 450, '', function(){
        $("#COL2").css('overflow', 'auto');
        });
        }
    }
    else //Open it
    {
        ...
        if(typeof(no_animate)=='undefined')
        {
            ...
            $(".leftmenu li").animate({opacity: 1}, 1500);
        }
        else
        {
        ...
        //Hide Col2
        if(width_col2 <= 460){
        $("#COL2").animate({opacity:'0', padding:'0'}, 400, '', function(){
        $("#COL2").css('overflow', 'hidden');
        });
        }
    ...
    $.set_grid_width('main_grid_container', cur_left);
