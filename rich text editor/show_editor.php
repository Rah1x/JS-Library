...
class make_editor
{
    ...
    function show_editor($fld_name, $height='300', $width='600', $current_content='')
    {
        ...
        ['body, table, td', false, '' ,'font-size:13px;'],
        ['table', false, '', 'border:dotted 1px gray;'],
        ['td', false, '', 'border:dotted 1px gray; height:20px;'],
        ['p', false, '', \"font:12px/18px Arial, Helvetica, sans-serif; margin:0 0 12px;\"],
        ['h1, h2, h3, h4, h5', false, '', \"font-family:'Lato', sans-serif;\"],
        ['b, strong', false, '', \"font: bold 13px Arial, Helvetica, sans-serif;\"],
        ['ul, ol', false, '', 'padding-left:25px; margin:0; '],
